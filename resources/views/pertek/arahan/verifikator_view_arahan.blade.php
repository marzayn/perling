                    ...
                    <div class="tab-content" id="permohonan-tabs-content">
                        ...
                        <div class="tab-pane fade" id="persyaratan" role="tabpanel" aria-labelledby="persyaratan-tab" tabindex="0">
                            <div class="row gy-4">
                                            ...
                                            <div class="file-preview-container mt-3">
                                                <div class="border rounded p-3 bg-light d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span class="text-warning text-xs mt-1 d-block">Perlu perbaikan (lihat catatan)</span>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="mt-2">
                                                <small class="text-muted d-block">Dokumen telah diupload, namun perlu dilakukan perbaikan</small>
                                ...
                                <!-- Additional documents would follow the same pattern -->
                            </div>
                        </div>
