                                ...
                                <form action="#" method="post">
                                            ...
                                            <div class="section-content">
                                                <div class="alert alert-info mb-4" role="alert">
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <strong>Konfirmasi Dokumen:</strong> Halaman ini menampilkan dokumen yang telah Anda unggah. Anda masih dapat menambahkan catatan jika diperlukan.
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="mt-2">
                                                                    ...
                                                                    <div class="mt-3 border-top pt-3">
                                                                        ...
                                                                        <div class="d-flex gap-2">
                                                                            <textarea class="form-control" rows="2" placeholder="Tulis catatan tambahan jika diperlukan..."></textarea>
                                                                            <button type="button" class="btn btn-sm btn-primary-600 d-flex align-items-center align-self-end">
                                                                                Kirim
                                    ...
                                    <fieldset class="wizard-fieldset">
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-center gap-8">
                                            <a href="{{ route('pertek.index_arahan') }}">
